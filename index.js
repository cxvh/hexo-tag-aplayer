...
/**
* hexo-tag-aplayer
* https://github.com/code-ba/hexo-tag-aplayer
* Copyright (c) 2016, Baran
...
hexo.extend.filter.register('after_render:html', function (raw, info) {
  ...
  if (view.isFullPage()) {
    ...
    if (view.hasTagMarker(_constant.APLAYER_TAG_MARKER) && !view.assetAlreadyInjected(_constant.APLAYER_SCRIPT_MARKER)) {
      ...
      view.injectAsset('<link rel="stylesheet" href="/style/APlayer.min.css" class="' + _constant.APLAYER_STYLE_MARKER + '">');
      ...
      view.injectAsset(_hexoUtil2.default.htmlTag('script', { src: "/js/APlayer.min.js", class: _constant.APLAYER_SCRIPT_MARKER }, ''));
    }
